...
export async function checkBalance(chain) {
...
async function checkERC20Balances(wallet, provider, chain) {
...
async function checkRWATokenBalances(wallet, chain) {
...
async function showBorrowingCapacity(walletAddress) {
    console.log('\n🏦 Borrowing Capacity Analysis:');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    try {
        const estimatedCollateralValue = 375000;
        const maxLTV = 0.75;
...
function getCommonTokensForChain(chain) {
    const tokens = {
        'ethereum': [
...
export async function getDetailedBalances(walletAddress) {
    const balances = {
        native: {},
        erc20: {},
        rwaTokens: {},
...
export async function checkLiquidationRisk(walletAddress) {
