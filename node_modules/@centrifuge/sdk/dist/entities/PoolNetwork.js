...
export class PoolNetwork extends Entity {
     ...
     */
    details() {
        return this._query(null, () => this.pool.shareClasses().pipe(switchMap((shareClasses) => {
    ...
    balanceSheet(scId) {
        return this._query(null, () => of(new BalanceSheet(this._root, this, new ShareClass(this._root, this.pool, scId.raw))));
    }
    /**
     ...
     */
    shareCurrency(scId) {
        return this._query(null, () => this._share(scId).pipe(switchMap((share) => this._root.currency(share, this.chainId))));
    }
    /**
    ...
    vaults(scId, includeUnlinked = false) {
        return this._query(null, () => this._root.pool(this.pool.id).pipe(switchMap((pool) => pool.shareClass(scId)), switchMap((shareClass) => shareClass.vaults(this.chainId, includeUnlinked))));
    }
    /**
     ...
     */
    _vaultsByShareClass() {
        return this._query(null, () => this.pool._shareClassIds().pipe(switchMap((scIds) => {
