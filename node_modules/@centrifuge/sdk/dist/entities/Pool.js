...
export class Pool extends Entity {
     ...
     */
    details() {
        return this._query(null, () => combineLatest([this.metadata(), this.shareClasses(), this.shareClassesDetails(), this.currency()]).pipe(map(([metadata, shareClasses, shareClassesDetails, currency]) => {
            return {
                id: this.id,
                currency,
                metadata,
    ...
    metadata() {
        return this._query(['metadata'], () => this._root._protocolAddresses(this.chainId).pipe(switchMap(({ hubRegistry }) => defer(() => {
    ...
    shareClasses() {
        return this._query(null, () => this._shareClassIds().pipe(map((scIds) => scIds.map((scId) => new ShareClass(this._root, this, scId.raw)))));
    }
    shareClass(scId) {
        return this._query(null, () => this.shareClasses().pipe(map((shareClasses) => {
     ...
     */
    _shareClassIds() {
        return this._query(['shareClasses'], () => this._root._protocolAddresses(this.chainId).pipe(switchMap(({ shareClassManager }) => defer(async () => {
    ...
    /** @internal */
    _escrow() {
        return this._query(['escrow'], () => this._root._protocolAddresses(this.chainId).pipe(switchMap(({ poolEscrowFactory }) => {
            return this._root.getClient(this.chainId).readContract({
