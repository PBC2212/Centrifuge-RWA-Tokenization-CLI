...
export class Vault extends Entity {
     ...
     */
    details() {
        return this._query(null, () => combineLatest([this.isLinked(), this._isSyncDeposit(), this._investmentCurrency(), this._shareCurrency()]).pipe(map(([isLinked, isSyncInvest, investmentCurrency, shareCurrency]) => ({
            pool: this.pool,
    ...
    investment(investor) {
        ...
        return this._query(['investment', investorAddress], () => combineLatest([
            ...
            this._isSyncDeposit(),
            this.pool._escrow(),
        ]).pipe(switchMap(([investmentCurrency, shareCurrency, addresses, restrictionManagerAddress, isSyncInvest, escrowAddress]) => combineLatest([
        ...
        return this._transact(async function* (ctx) {
            ...
            if (needsApproval) {
                ...
                if (!permit) {
                    ...
                    yield* doTransaction('Approve', ctx.publicClient, () => ctx.walletClient.writeContract({
            ...
            if (isSyncDeposit) {
                yield* doTransaction('Invest', ctx.publicClient, () => ctx.walletClient.writeContract({
                    address: vaultRouter,
                    abi: ABI.VaultRouter,
