...
describe('PoolNetwork', () => {
    ...
    it('deploys share classes and vaults', async () => {
        ...
        const vault = new Vault(context.centrifuge, new PoolNetwork(context.centrifuge, new Pool(context.centrifuge, poolId.raw, chainId), chainId), details.activeShareClasses[1].shareClass, asset.address, vaultAddr, AssetId.from(1, 1));
